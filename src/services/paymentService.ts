...
const PACKAGES: Record<string, PackageConfig> = {
  ...
  pack10: {
    ...
    unlimitedDays: 0,
    unlimitedLimit: 0,
    description: '10 анализов товаров из Китая. Закупочный пакет: вопросы поставщику, ТЗ байеру, ТЗ карго, чек-лист образца и SEO-черновик. Кредиты не сгорают.',
  },
  pack30: {
    stars: 300,
    label: '30 анализов',
    ...
    unlimitedDays: 0,
    unlimitedLimit: 0,
    description: '30 анализов товаров из Китая. Закупочный пакет: вопросы поставщику, ТЗ байеру, ТЗ карго, чек-лист образца и SEO-черновик. Кредиты не сгорают.',
  },
  week: {
    stars: 500,
    label: '7 дней Pro',
    ...
    unlimitedDays: 7,
    unlimitedLimit: 100,
    description: 'Доступ на 7 дней: до 100 анализов товаров из Китая. Закупочный пакет: вопросы поставщику, ТЗ байеру, ТЗ карго, чек-лист образца и SEO-черновик.',
  },
};
