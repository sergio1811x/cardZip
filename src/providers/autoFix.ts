...
* буквальные запрещённые claims даже в секциях “нельзя писать” — заменить на нейтральные категории: “влагозащита без подтверждения”, “сертификация без документов”, “обещания безопасности/качества без подтверждения”;
