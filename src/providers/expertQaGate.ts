...
8. Нет ROI как факта без ручной продажной цены и условий расчёта.

Не блокируй: отсутствие WB, “ROI не считаю”, “рынок проверить вручную”, вопросы про сертификаты, “медицинские сабо” как тип товара.
