...
- bullets: РОВНО 5, каждый про РАЗНОЕ (не дублируй материал): 1) основное применение/сценарии, 2) конструкция/форм-фактор (что видно на фото), 3) заявленный материал, 4) уход/эксплуатация, 5) для кого/универсальность или комплектация. Конкретно и для ПОКУПАТЕЛЯ. НЕ вода, НЕ «уточните у поставщика», НЕ «SKU в карточке».
- characteristics: 5–8 объектов {name, value, status}. value ставь ТОЛЬКО если оно есть в «Подтверждённых атрибутах», и тогда status="заявлено, уточнить" (это claim продавца, не факт); если значения нет — value="уточнить", status="подтвердить". Включай полезные покупателю параметры (материал, тип, назначение, размеры, комплектация). НЕ включай расплывчатые/маркетинговые атрибуты (стиль «новый китайский», «классический дизайн»). Коды/марки сохраняй ЦЕЛИКОМ (3Cr13, а не Cr13). Китайские значения переводи на русский.
- КАТЕГОРИЧЕСКИ НЕ придумывай числа: длину, ширину, толщину, угол, HRC, вес, размеры, мощность. Нет числа в «Подтверждённых атрибутах» — не пиши его (в буллетах — вообще, в характеристиках — value="уточнить").
