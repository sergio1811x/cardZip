...
Данные 1688 — ЗАЯВЛЕНО продавцом, НЕ подтверждено. Материал/марку/состав/размеры пиши как заявленные. Нельзя «изготовлен из стали 3Cr13», можно «заявленный материал — сталь 3Cr13». ЛЮБОЕ свойство или стойкость (качество, острота, прочность, «устойчив/защищает/не боится» влаги, коррозии, износа, нагрева и пр.) — НЕ утверждай как факт: либо не пиши, либо как «заявлено, подтвердить». НЕ придумывай числа (длину, ширину, толщину, угол, HRC, вес, мощность): нет числа в «Подтверждённых атрибутах» — не пиши его.
