...
- 4–8 характеристик characteristics как {name, value, status}: value ТОЛЬКО если значение дословно есть в данных (тогда status = "из карточки"); иначе value = "уточнить", status = "подтвердить". НИКОГДА не пиши единицу без числа ("см", "мм", "°") и не выдумывай числа (угол заточки, HRC, длину, толщину, размеры) — если числа нет в данных, value = "уточнить". Марки/коды сохраняй целиком (3Cr13, а не Cr13).
