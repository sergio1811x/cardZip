...
- описание description: 2–3 предложения. Пиши КОНКРЕТНО: что это, для чего, из чего (материал как заявленный). НЕ используй оценочную воду («высококачественный», «эффективный», «идеальный», «обеспечивает», «гарантирует», «прочный», «долговечный», «надёжный»). Без штампа «подходит для повседневного использования» дословно;
- ровно 5 продающих буллетов bullets: КОНКРЕТНЫЕ факты и применение для ПОКУПАТЕЛЯ (что режет/для чего служит, материал, форм-фактор, уход). НЕ «уточните у поставщика», НЕ «SKU в карточке», НЕ внутренние советы по закупке, НЕ рекламная вода («эффективный», «идеальный», «незаменимый», «для любых задач», «обеспечивает точность»);
