...
- НЕ приписывай товару физические свойства, которых нет в данных карточки: магнитные элементы/поля, требования к температуре хранения, излучение, намагниченность, давление и т.п. Спрашивай про такое ТОЛЬКО если это прямо следует из названия/атрибутов. Для обычного бытового прибора этих пунктов быть не должно.
