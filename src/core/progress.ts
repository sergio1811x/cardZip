...
const STEP_MESSAGES: Record<string, string[]> = {
  elim: [
    ...
    '📡 <b>Шаг 1/4</b> — Парсим атрибуты товара...',
    '📡 <b>Шаг 1/4</b> — Определяем вес и размеры...',
    '📡 <b>Шаг 1/4</b> — Почти загрузили, ещё немного...',
    '📡 <b>Шаг 1/4</b> — Проверяем данные поставщика...',
  ],
  process: [
    ...
    '🔍 <b>Шаг 3/4</b> — Оцениваем качество выборки WB...',
    '🤖 <b>Шаг 2/4</b> — Готовим вопросы поставщику...',
    '⚠️ <b>Шаг 3/4</b> — Проверяем риски товара...',
  ],
  send: [
    ...
    '📦 <b>Шаг 4/4</b> — Считаем тестовую закупку...',
